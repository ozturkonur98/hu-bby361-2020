<?php
    ...
    $yayinevi_guncellenecek = mysqli_real_escape_string($baglanti, $_GET["YayineviKayitNO"]);
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yayinevi WHERE YayineviKayitNO = $yayinevi_guncellenecek");
