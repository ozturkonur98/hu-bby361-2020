<?php
    ...
    $EserinAdi = mysqli_real_escape_string($baglanti, $_POST['EserinAdi']);
    $EserISBN = mysqli_real_escape_string($baglanti, $_POST['EserISBN']);
    $EserinBTarihi = mysqli_real_escape_string($baglanti, $_POST['EserinBTarihi']);
    ...
    $sorgu = "UPDATE eserler SET EserinAdi = '$EserinAdi', EserISBN = '$EserISBN', EserISBN = '$EserISBN', EserinBTarihi = '$EserinBTarihi', YazarKayitNO = '$YazarKayitNO', YayineviKayitNO = '$YayineviKayitNO', EserAciklama = '$EserAciklama' WHERE EserKayitNO = $EserKayitNO";
    $sorgu2 = mysqli_query($baglanti, 
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM eserler ORDER BY EserKayitNO DESC");
