<?php
    ...
    $sorgu = "INSERT INTO eserler (EserinAdi, EserISBN, EserinBTarihi, YazarKayitNO, YayineviKayitNO, EserAciklama)
            VALUES ('$EserinAdi', '$EserISBN', '$EserinBTarihi', '$YazarKayitNO', '$YayineviKayitNO', '$EserAciklama')";
