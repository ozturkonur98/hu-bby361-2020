...
<form action="eser_eklendi.php" method="post">
    Eser Adi: <input type="text" name="EserinAdi"><br>
    Eser ISBN: <input type="text" name="EserISBN"><br>
    Eser Basim Tarihi: <input type="text" name="EserinBTarihi"><br>
    ...
    Eser Aciklama: <input type="text" name="EserAciklama"><br>
