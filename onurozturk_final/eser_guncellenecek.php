<?php
    ...
    $eser_guncellenecek = mysqli_real_escape_string($baglanti, $_GET["EserKayitNO"]);
    $sorgu = mysqli_query($baglanti, "SELECT * FROM eserler WHERE EserKayitNO = $eser_guncellenecek");
...
<form action="eser_guncellendi.php" method="post">
    Eser Adı: <input type="text" name="EserinAdi" value="<?php echo $satir["EserinAdi"] ;?>"><br><br>
    Eser ISBN: <input type="text" name="EserISBN" value="<?php echo $satir["EserISBN"] ;?>"><br><br>
    Eser Basim Yili: <input type="text" name="EserinBTarihi" value="<?php echo $satir["EserinBTarihi"] ;?>"><br><br>  
    Eser Aciklama: <input type="text" name="EserAciklama" value="<?php echo $satir["EserAciklama"] ;?>"><br><br>  
    Yazar Adi:<select name="YazarKayitNO" id="YazarKayitNO">
    ...
    <input type="submit" value="Eser Güncelle">
</form>
<!-- KODLAR -->   
</main>
