...
<?php while($satir = mysqli_fetch_assoc($sorgu)){?>
  <option value="<?php echo $satir["YazarKayitNO"];?>"><?php echo $satir["YazarAdi"].' '. $satir["YazarSoyadi"];?></option>
<?php }?>
</select>
</form><hr> <hr>
</main>
      ...
      <div class="row">
        <div class="col-sm-12 text">
          <div class="copyright-box">
            <p class="copyright">&copy; Copyright <strong>ONUR ÖZTÜRK</strong>. All Rights Reserved</p>
            <div class="credits">
         
              Designed by <a href="https://www.instagram.com/ozturkonur98/?hl=tr">ONUR OZTURK</a>
            </div>
          </div>
        </div>
      </div>
